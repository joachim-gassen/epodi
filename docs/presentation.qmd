...
Recognized earnings reflect the effects of $\pi_t$ and $\psi_t$, making earnings relatively stochastic. Expensed earnings 'mute' these effects by deducting $I_t$ which, as it also is driven by $e_t$, makes earnigs less stochastic (more persistent) 
...
- Some more detail on the techicalities of the model implementation (e.g., grid, firm initialization) and empirical analysis (e.g., outlier treatment) would be nice
